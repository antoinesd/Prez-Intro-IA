...
----
"chat"    → [0.23, -0.87, 0.41, ...]
"chien"   → [0.25, -0.84, 0.39, ...]  ← proche
"voiture" → [-0.71, 0.12, -0.55, ...] ← loin
----
...
[.key-insight]
GPT-4 : ~96 têtes par couche × 96 couches ≈ 9 216 "regards" simultanés.
...
[.beam-search]
----
Entrée : "Pour faire une omelette, il faut..."
                            ↓
      ┌─────────────────────┴──────────────────┐
   "casser"(0.42)    "battre"(0.31)    "mélanger"(0.18)
      ↓                    ↓                   ↓
