...
=== Même mécanisme, domaines différents

Ce qui varie :

* le vocabulaire (mots, pixels, notes, acides aminés...)
...
[.key-insight]
Image en patches, mélodie, ADN, code : tout peut devenir une séquence de tokens.

→ Un paradigme commun pour des domaines très différents.
...
Vs pipeline classique : 4-5 ans pour atteindre ce stade.
